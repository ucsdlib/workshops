...
2. Use the **mtcars** database available in RStudio, create a scatter plot that shows the relationship between various car weights (wt), miles per gallon (mpg) and engine cylinders (cyl). Use colored points to show the different cylinders in the plot.
...
3. (10pts) Creating an area graph
