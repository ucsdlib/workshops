...
* **Key** to understanding `ggplot2` is thinking aobut a figure in layers -- think of arcgis or programs like Photoshop
...
* Then add layers of geometric objects, statistical models, andpanels.
